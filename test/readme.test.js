...
describe('readme', () => {
  ...
  describe('table 1', () => {
    ...
    it('input = `C:\\example`, base = `https://base.com/`', () => {
    ...
    it('input = `C:\\example`, base = `//base.com/`', () => {
      const input = `C:\\example`;
      const base = `//base.com/`;
      const expected = `//base.com/example`;
    ...
    it('input = `C:\\example`, base = _rest_', () => {
      const input = `C:\\example`;
      const base = _rest_;
      const expected = `C:\\example`;
    ...
    it('input = `example`, base = `C:\\base\\dir\\`', () => {
      const input = `example`;
      const base = `C:\\base\\dir\\`;
      const expected = `C:\\base\\dir\\example`;

      assert.strictEqual(resolve(input, base), expected);
    });

    it('input = `example`, base = `C:\\base\\file`', () => {
      const input = `example`;
      const base = `C:\\base\\file`;
      const expected = `C:\\base\\example`;
