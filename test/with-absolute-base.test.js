  ...
  describe(`base = "https://foo.com"`, () => {
    ...
    describe('with relative input', () => {
      ...
      it('resolves node_module scope as path', () => {
        ...
        const resolved = resolve(input, base);
        assert.strictEqual(resolved, 'https://foo.com/node_modules/@babel/runtime/helpers/esm/arrayLikeToArray.js');
      });
      ...
      it('resolves package scope as path', () => {
        ...
        const resolved = resolve(input, base);
        assert.strictEqual(resolved, 'https://foo.com/@babel/runtime/helpers/esm/arrayLikeToArray.js');
      });
    });
  ...
  describe(`base = "https://foo.com/dir/"`, () => {
    ...
    describe('with relative input', () => {
      ...
      it('resolves node_module scope as path', () => {
        ...
        const input = 'node_modules/@babel/runtime/helpers/esm/arrayLikeToArray.js';
        const resolved = resolve(input, base);
        assert.strictEqual(resolved, 'https://foo.com/dir/node_modules/@babel/runtime/helpers/esm/arrayLikeToArray.js');
      });
      ...
      it('resolves package scope as path', () => {
        ...
        const input = '@babel/runtime/helpers/esm/arrayLikeToArray.js';
        const resolved = resolve(input, base);
        assert.strictEqual(resolved, 'https://foo.com/dir/@babel/runtime/helpers/esm/arrayLikeToArray.js');
      });
    });
  ...
  describe(`base = "https://g"`, () => {
    ...
    describe('with relative input', () => {
      ...
      it('resolves node_module scope as path', () => {
        ...
        const input = 'node_modules/@babel/runtime/helpers/esm/arrayLikeToArray.js';
        const resolved = resolve(input, base);
        assert.strictEqual(resolved, 'https://g/node_modules/@babel/runtime/helpers/esm/arrayLikeToArray.js');
      });
  ...
  describe(`base = "https://g/dir/"`, () => {
    ...
    describe('with relative input', () => {
      ...
      it('resolves node_module scope as path', () => {
        ...
        const input = 'node_modules/@babel/runtime/helpers/esm/arrayLikeToArray.js';
        const resolved = resolve(input, base);
        assert.strictEqual(resolved, 'https://g/dir/node_modules/@babel/runtime/helpers/esm/arrayLikeToArray.js');
      });
      ...
      it('resolves package scope as path', () => {
        ...
        const input = '@babel/runtime/helpers/esm/arrayLikeToArray.js';
        const resolved = resolve(input, base);
        assert.strictEqual(resolved, 'https://g/dir/@babel/runtime/helpers/esm/arrayLikeToArray.js');
      });
    });
  ...
  describe(`base = "file:///foo"`, () => {
    ...
    describe('with absolute Windows path input', () => {
      it('remains absolute path', () => {
        ...
        const input = 'C:\\assets\\main.js.map';
        const resolved = resolve(input, base);
        assert.strictEqual(resolved, 'file:///C:/assets/main.js.map');
      });
      ...
      it('trims to root', () => {
        ...
        const input = 'C:\\';
        const resolved = resolve(input, base);
        assert.strictEqual(resolved, 'file:///C:/');
      });
      ...
      it('normalizes input', () => {
        ...
        const input = 'C:\\foo\\.\\bar\\..\\main.js.map';
        const resolved = resolve(input, base);
        assert.strictEqual(resolved, 'file:///C:/foo/main.js.map');
      });
      ...
      it('normalizes current directory', () => {
        ...
        const input = 'C:\\.\\main.js.map';
        const resolved = resolve(input, base);
        assert.strictEqual(resolved, 'file:///C:/main.js.map');
      });
    ...
    describe('with relative input', () => {
      ...
      it('resolves node_module scope as path', () => {
        ...
        const input = 'node_modules/@babel/runtime/helpers/esm/arrayLikeToArray.js';
        const resolved = resolve(input, base);
        assert.strictEqual(resolved, 'file:///node_modules/@babel/runtime/helpers/esm/arrayLikeToArray.js');
      });
  ...
  describe(`base = "file:///foo/"`, () => {
    ...
    describe('with relative input', () => {
      ...
      it('resolves node_module scope as path', () => {
        ...
        const input = 'node_modules/@babel/runtime/helpers/esm/arrayLikeToArray.js';
        const resolved = resolve(input, base);
        assert.strictEqual(resolved, 'file:///foo/node_modules/@babel/runtime/helpers/esm/arrayLikeToArray.js');
      });
  ...
  describe(`base = "file:///foo/dir/"`, () => {
    ...
    describe('with relative input', () => {
      ...
      it('resolves node_module scope as path', () => {
        ...
        const input = 'node_modules/@babel/runtime/helpers/esm/arrayLikeToArray.js';
        const resolved = resolve(input, base);
        assert.strictEqual(resolved, 'file:///foo/dir/node_modules/@babel/runtime/helpers/esm/arrayLikeToArray.js');
      });
      ...
      it('resolves package scope as path', () => {
        ...
        const input = '@babel/runtime/helpers/esm/arrayLikeToArray.js';
        const resolved = resolve(input, base);
        assert.strictEqual(resolved, 'file:///foo/dir/@babel/runtime/helpers/esm/arrayLikeToArray.js');
      });
    });
